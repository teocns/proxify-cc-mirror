...
<Tip>Claude can create and manage tmux sessions on its own. Just describe what you want tested and mention tmux as the approach.</Tip>
...
<Warning>**Always commit before delegating** — If Claude breaks something, `git checkout .` gets you back. Without a commit, your work is gone.</Warning>
