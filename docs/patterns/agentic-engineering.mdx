...
### Skills
Domain knowledge that loads when relevant. Instead of explaining your testing philosophy every session, encode it in a skill. See the [skills overview](../skills/overview/).
...
**Next:** [Maturity Ladder →](maturity-ladder/) · [Workflow Patterns →](workflow-patterns/)
