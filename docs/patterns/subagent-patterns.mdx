...
:::tip
You don't need special syntax. Just tell Claude to "use subagents for this" or "parallelize this work across subagents" and it will. Start with exploration tasks — they're the easiest win.
:::
