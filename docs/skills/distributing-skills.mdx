...
<Tip>This page covers the mechanics of sharing skills via GitHub. For the architectural thinking behind *why* knowledge lives in skills vs. CLAUDE.md vs. agents, see [Context Distribution](../patterns/distribution/).</Tip>
